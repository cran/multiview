...
static const R_CallMethodDef CallEntries[] = {
    {"_multiview_wls_exp", (DL_FUNC) &_multiview_wls_exp, 28},
    {"_multiview_spwls_exp", (DL_FUNC) &_multiview_spwls_exp, 30},
    {NULL, NULL, 0}
};

RcppExport void R_init_multiview(DllInfo *dll) {
